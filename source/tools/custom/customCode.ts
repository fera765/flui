  ...
  params: [
    {
      ...
      ui: {
        ...
        helperText: 'Linguagem do código a ser executado',
      },
    },
    {
      name: 'Código',
      ...
      ui: {
        ...
        placeholder: 'console.log("Hello World");',
        helperText: 'Código que será executado em sandbox isolado. Use "input" para acessar dados de entrada.',
    ...
    },
    {
      ...
      ui: {
        ...
        placeholder: '{\n  "key": "value"\n}',
        helperText: 'Dados que estarão disponíveis na variável "input" dentro do código',
        codeLanguage: 'json',
    ...
    },
    {
      ...
      ui: {
        widgetType: 'number',
        placeholder: '10000',
        helperText: 'Tempo máximo de execução (padrão: 10s)',
        validation: {
          min: 1000,
          max: 60000,
        },
