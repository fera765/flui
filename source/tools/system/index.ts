  ...
  const tools = [
    {
      ...
      category: 'system',
      version: '1.0.0',
      output: { type: 'object', description: 'Search results with matching files' },
      params: [
        { name: 'path', type: 'string', description: 'Directory path to search', required: true },
        { name: 'pattern', type: 'string', description: 'File pattern (e.g., *.txt, **/*.js)', required: true },
        { name: 'recursive', type: 'boolean', description: 'Search recursively in subdirectories', required: false },
      ],
    ...
    },
    {
      ...
      category: 'system',
      version: '1.0.0',
      output: { type: 'object', description: 'File content and metadata' },
      params: [
        { name: 'path', type: 'string', description: 'File path to read', required: true },
        { name: 'encoding', type: 'string', description: 'Encoding (utf-8, binary, base64)', required: false },
      ],
      execute: async (args: any) => {
    ...
    },
    {
      ...
      category: 'system',
      version: '1.0.0',
      output: { type: 'object', description: 'Folder contents with files and directories' },
      params: [
        { name: 'path', type: 'string', description: 'Folder path to list', required: true },
        { name: 'includeStats', type: 'boolean', description: 'Include file statistics', required: false },
      ],
      execute: async (args: any) => {
    ...
    },
    {
      ...
      category: 'system',
      version: '1.0.0',
      output: { type: 'object', description: 'Results from reading multiple files' },
      params: [
        { name: 'paths', type: 'array', description: 'Array of file paths', required: true },
        { name: 'encoding', type: 'string', description: 'Encoding for all files', required: false },
        { name: 'continueOnError', type: 'boolean', description: 'Continue if some files fail', required: false },
      ],
      execute: async (args: any) => {
    ...
    },
    {
      ...
      category: 'system',
      version: '1.0.0',
      output: { type: 'object', description: 'Write operation result' },
      params: [
        { name: 'path', type: 'string', description: 'File path to write', required: true },
        { name: 'content', type: 'string', description: 'Content to write', required: true },
        { name: 'createDirs', type: 'boolean', description: 'Create parent directories', required: false },
    ...
    },
    {
      ...
      category: 'system',
      version: '1.0.0',
      output: { type: 'object', description: 'Search matches with line numbers' },
      params: [
        { name: 'path', type: 'string', description: 'File or directory path', required: true },
        { name: 'pattern', type: 'string', description: 'Text pattern to search', required: true },
        { name: 'regex', type: 'boolean', description: 'Use regex pattern', required: false },
        { name: 'recursive', type: 'boolean', description: 'Search in subdirectories', required: false },
      ],
      execute: async (args: any) => {
    ...
    },
    {
      ...
      category: 'system',
      version: '1.0.0',
      output: { type: 'object', description: 'Replacement operation result' },
      params: [
        ...
        { name: 'regex', type: 'boolean', description: 'Use regex', required: false },
    ...
    },
    {
      ...
      category: 'system',
      version: '1.0.0',
      output: { type: 'object', description: 'Command execution result with stdout/stderr' },
      params: [
    ...
    },
    {
      ...
      category: 'system',
      version: '1.0.0',
      output: { type: 'object', description: 'Task status and information' },
      params: [
        { name: 'action', type: 'string', description: 'Action: start, status, cancel, list', required: false },
        { name: 'command', type: 'string', description: 'Command to run', required: false },
    ...
    },
    {
      ...
      category: 'system',
      version: '1.0.0',
      output: { type: 'object', description: 'HTTP response with status and data' },
      params: [
