...
describe('Agents API', () => {
    ...
    describe('POST /api/agents', () => {
        it('should create a new agent', async () => {
            ...
            mockStore.createAgent.mockImplementation((agent) => {
                const created = {
                    ...agent,
                    id: '123',
                    enabled: true,
    ...
    describe('PUT /api/agents/:id', () => {
        it('should update an existing agent', async () => {
            ...
            mockStore.updateAgent.mockImplementation((id, updates) => {
    ...
    describe('DELETE /api/agents/:id', () => {
        it('should delete an agent', async () => {
            ...
            mockStore.deleteAgent.mockImplementation((id) => {
                mockStore.agents = mockStore.agents.filter((a) => a.id !== id);
            });
...
function setupAgentRoutes(app, store) {
